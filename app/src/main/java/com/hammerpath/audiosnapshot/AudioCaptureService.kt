...
class AudioCaptureService : Service() {
    ...
    private fun startAudioCapture(intent: Intent?) {
        val config = AudioPlaybackCaptureConfiguration.Builder(mediaProjection!!)
            .addMatchingUsage(AudioAttributes.USAGE_MEDIA)
             .addMatchingUsage(AudioAttributes.USAGE_GAME)// TODO provide UI options for inclusion/exclusion
            .build()
        ...
        audioCaptureThread = thread(start = true) {
            ...
            writeAudioToFile(outputFile, intent)
        }
    }
    ...
    private fun writeAudioToFile(outputFile: File, intent: Intent?) {
